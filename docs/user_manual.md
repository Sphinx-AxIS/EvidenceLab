...
- If an Analytics results table is wider than the page, a fixed horizontal scrollbar appears near the bottom of the viewport so you can move across columns without scrolling down to the end of the results block first.
